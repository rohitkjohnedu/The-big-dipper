...
// =============================================================================
// state_machine.cpp — Implementation
// =============================================================================
...
//   RUNNING → PAUSED | READY (on complete) | ERROR
//   PAUSED  → RUNNING | READY (on stop) | ERROR
...
void StateMachine::toRunning() {
    _state = SystemState::RUNNING;
}

void StateMachine::toPaused() {
    _state = SystemState::PAUSED;
}
...
void StateMachine::setPhase(RunPhase phase) {
    _phase = phase;
}
...
// -----------------------------------------------------------------------------
// Human-readable strings for telemetry
// -----------------------------------------------------------------------------
